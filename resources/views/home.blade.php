...
<!-- End Slider -->
	...
	@include('layouts.home_service')
	<!-- Home About  -->
	@include('layouts.home_about')
	@include('layouts.home_testimony')
	<!-- End Home About -->


    @include('layouts.home_rooms')

	@include('layouts.home_rest')

	<!-- @include('layouts.home_blog') -->

	@include('layouts.home_pic')
