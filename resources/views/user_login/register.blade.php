  ...
  <body>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('register') }}" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Alpha</span>
                </a>
              </div>
              ...
              <form class="mb-3" action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" placeholder="Enter your email" id="email" type="email" name="email" :value="old('email')" required autocomplete="username"/>
                </div>
    ...
    <!-- <div class="buy-now">
      <a
        ...
        target="_blank"
        class="btn btn-sm btn-danger btn-buy-now"
        >Upgrade to Pro</a
      >
    </div> -->
