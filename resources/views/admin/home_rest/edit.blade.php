                ...
                <div class="col-xl">
                  <div class="col-xl">
                    <div class="card mb-12">
                      ...
                      <div class="card-body">
                      <form action="{{url('home/rest/update/'.$home_rests->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="old_image_1" value="{{$home_rests->image}}">
                            <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="image" name="image" value="{{ $home_rests ->image}}"/>
                        @error('image')
                        ...
                        <div class="form-group">
                            <img src="{{asset($home_rests-> image)}}" style="width: 350px; height: 250px;">
                        </div>
                        </div>
