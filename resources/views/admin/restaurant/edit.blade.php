                ...
                <div class="col-xl">
                  <div class="col-xl">
                    <div class="card mb-12">
                      ...
                      <div class="card-body">
                      <form action="{{url('home/restaurant/update/'.$restaurants->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="old_image_1" value="{{$restaurants->image}}">
                            <div class="mb-3">
                        ...
                        <input class="form-control" type="file" id="image" name="image" value="{{ $restaurants ->image}}"/>
                        @error('image')
                        ...
                        <div class="form-group">
                            <img src="{{asset($restaurants-> image)}}" style="width: 350px; height: 250px;">
                        </div>
                        </div>

                            
                          <button type="submit" class="btn btn-primary"><i class='bx bx-layer-plus'></i> Update Home Restaurant</button>
                        </form>
                      </div>
                    </div>
                  </div>
